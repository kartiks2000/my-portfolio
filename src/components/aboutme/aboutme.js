    ...
    return(
        <div className="aboutme">
            ...
            <div className="aboutme-text">
                <p className="at">
                    Hello, as you all know i am Kartik Saxena. I am a third year student persuing Bachelor of Engneering in the field of computer science. Well, yup computer science but not because its trendy out there but because its always trending within me.
                </p>
                <p className="at">
